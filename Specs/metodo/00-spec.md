...
- A fala usa a **voz masculina neural do Google** (`pt-BR-Chirp3-HD-Orus`, natural, próxima, firme e grave) quando configurada; sem chave ou em falha, usa a melhor voz local do navegador. Texto direto, sem exclamações.
