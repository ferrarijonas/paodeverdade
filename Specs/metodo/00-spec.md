...
- A fala usa a **voz masculina neural do Google** (`pt-BR-Wavenet-B`, grave e sóbria) quando configurada; sem chave ou em falha, usa a melhor voz local do navegador. Texto direto, sem exclamações.
