...
- A fala usa a **melhor voz pt-BR disponível** (preferência por voz `Online`/`Natural`, ex. Maria/Davos) e **texto natural por extenso** (`Terceira dobra`, `Hora de modelar a massa`, `Hora de ir para o frio`).
